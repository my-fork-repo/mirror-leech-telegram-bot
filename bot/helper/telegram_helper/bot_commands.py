...
class _BotCommands:
    def __init__(self):
        ...
        self.AuthorizeCommand = f"a{CMD_SUFFIX}"
        self.UnAuthorizeCommand = f"unauthorize{CMD_SUFFIX}"
        self.AddSudoCommand = f"addsudo{CMD_SUFFIX}"
        self.RmSudoCommand = f"rmsudo{CMD_SUFFIX}"
        self.PingCommand = f"ping{CMD_SUFFIX}"
        self.RestartCommand = f"r{CMD_SUFFIX}"
        self.StatsCommand = f"st{CMD_SUFFIX}"
        self.HelpCommand = f"help{CMD_SUFFIX}"
        self.LogCommand = f"log{CMD_SUFFIX}"
        self.ShellCommand = f"ba{CMD_SUFFIX}"
        self.AExecCommand = f"ev{CMD_SUFFIX}"
