...
async def get_readable_message(sid, is_user, page_no=1, status="All", page_step=1):
    ...
    msg =<pre> Add me in your group</pre><a href="https://t.me/rootedcyber_bot?startgroup=add">click here</a>
    msg =<pre>joined leeched group</pre><a href="https://t.me/leechedgroup">click here</a>
    return msg, button
